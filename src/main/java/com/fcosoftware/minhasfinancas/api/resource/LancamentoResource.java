...
import com.fcosoftware.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.fcosoftware.minhasfinancas.api.dto.LancamentoDTO;
...
public class LancamentoResource {
	...
	//private LancamentoService service; mais um argumento
		...
		return service.obterPorId(id).map(entity -> {
			...
			if(statusLancamento == null) {
				return ResponseEntity.badRequest()
						.body("Não possivel atualizar o status do lançamento, envie um estatus válido");
			}
				try {
